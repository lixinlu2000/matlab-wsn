function out=radio_channel_SINR(varargin)
...
% This version incorporates Martin Haenggi's (Univ. Notre Dame) propagation model:
% The successful reception now depends on the SUM of the disturbing powers 
% rather than the max of them.
...
persistent transmit_power total_rec_power receive_power receive_ID
%%%%%%%%%% radio_data:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [new_radiotopology, total_rec_power_update]=radio_topology(new_topology, old_topology, old_radiotopology, transmit_power);
