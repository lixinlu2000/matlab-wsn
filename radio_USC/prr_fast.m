...
function result = prr_fast(d,varargin)
...
snr = 10.^((rssi - NOISE_FLOOR)/10);   % division by .64 converts from Eb/No to RSSI
                                            % this is specific for each receiver see paper 
snr = snr /.64;   % division by .64 converts from Eb/No to RSSI
